...
The preprocessed and cleaned tidy data set located in this repository with the name tidy_smartphone_data.txt. This data file is in a text format with space as a delimeter between the values. The first row contains the names of the variables and the following rows contain the values of these variables.
